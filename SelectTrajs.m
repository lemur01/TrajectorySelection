...
% based on: 
% Amat, et al.- Efficient processing and analysis of large-scale light-sheet microscopy data, 
%               Nature Protocols 2015 (10)1679
%               http://dx.doi.org/10.1038/nprot.2015.111
% and the software therein (Supplementary_Software_6\)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
